                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type='text' name="nama" class="form-control" rows="3" required oninvalid="setCustomValidity('input Departemen / Subdepartemen masih kosong')"
                                   oninput="setCustomValidity('')" placeholder="Nama Departement / Subdepartemen" autofocus>
                            <?php echo form_error('nama', '<div class="text-red">', '</div>'); ?>
                        </div> 
                        <div class="form-group">
                            <label for="">Nama Ruang</label>
                            <input type='text' name="ruang" class="form-control" rows="3" required oninvalid="setCustomValidity('input Nama Ruang masih kosong')"
                                   oninput="setCustomValidity('')" placeholder="Nama Ruang">
                            <?php echo form_error('ruang', '<div class="text-red">', '</div>'); ?>
                        </div>                        
                        <div class="form-group">
