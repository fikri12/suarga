...
<head>
    <meta charset="UTF-8">
    <title>Suarga IT Assets Management & Tiketing</title>
...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; 2024 <a href="#">Fikri Aditia -IT Asset Management</a> - </strong> All rights reserved
        </footer>
    ...
    <!-- <script src="<?php echo base_url('assets/js/plugins/datepicker/locales/bootstrap-datepicker.id.js'); ?>"></script> -->
    <!-- FastClick -->
...
<script>
    ...
    function changeGroup(id) {
        ...
        $.ajax({
            type: "POST",
            dataType:"json",
            url : "<?php echo site_url('group/getsession');?>",
            data : { 'gid':gid},
