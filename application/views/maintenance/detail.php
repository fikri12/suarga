                      ...
                      <div class="tab-pane active" id="tab_1">
                        <div class="col-md-6 ">                        
                          ...
                          <br>
                            ...
                            <tr>
                              <td style="text-align:right">File Lampiran :</td>
                              <td>
                              <?php 
                                  $url = base_url('assets/upload/'.$recordall['file_lampiran']);                                  
                                  echo $recordall['file_lampiran'] !=null ? anchor($url,'Lampiran', ['target' => '_blank']) : ' - ';
                                ?>                             
                              </td>                    
                            </tr>
                          </table>
