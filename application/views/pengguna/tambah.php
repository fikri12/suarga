                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <input type="tex" name="nik" class="form-control" required oninvalid="setCustomValidity('NIK Harus di Isi !')"
                                   oninput="setCustomValidity('')" placeholder="Nomor Induk Karyawan " autofocus>
                                   <?php echo form_error('nik', '<div class="text-red">', '</div>'); ?>
                        </div>                                            
                        <div class="form-group">
                            <label for="">Nama Pengguna</label>
                            <input type="text" class="form-control" name="pengguna" required oninvalid="setCustomValidity('Nama Harus di Isi !')"
