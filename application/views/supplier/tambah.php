                ...
                ?> 
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <input type="tex" name="nama" class="form-control" required oninvalid="setCustomValidity('Nama Barang Harus di Isi !')"
                                   oninput="setCustomValidity('')" placeholder="Masukan Nama Barang" autofocus>
                                   <?php echo form_error('nama', '<div class="text-red">', '</div>'); ?>
                        </div>
                        <div class="form-group">
                            <label for="example">Alamat</label>
                            <textarea name="alamat" class="form-control" required oninvalid="setCustomValidity('Alamat Harus di Isi !')"
