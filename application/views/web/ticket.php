        ...
        <div class="row">
          <div class="col-md-5">			     
            <div class="ticket_form">
              ...
              <div class="btn-group"> <a href="javascript:void(0)" class="btn btn-sm ticket_btn" id="btn_perbaikan">Maintenance</a> </div>
              <div class="btn-group"> <a href="javascript:void(0)" class="btn btn-sm ticket_btn_2" id="btn_pengajuan">PC Submission</a> </div>
              <br><br>
              <fieldset id="form_perbaikan">
                <?php echo form_open_multipart('web/addticket');?> 
                <h4><span class="semi-bold">Inventory Ticket</span></h4>
                <p>Create a Repair Request for your Inventory, Enter the Inventory Number and provide your complaint information.</p>
                <div class="ticket_option">
                  ...
                  <div class="form_ticket_subject"> <span class="semi-bold">Type Inventory</span>
                    ...
                    <select name="kategori" class="form-control" id="kategori" >  
                        <option value="" selected="selected">- Inventory Types -</option>                 
                ...
                <div class="ticket_option">
                    <div class="form_ticket_subject"><span class="semi-bold">Applicant Name</span>
                      <div class="form-group">
                      <select name="inventaris" class="form-control select2" id="inventaris"> 
                          <option value="" selected="selected">- Applicant Name-</option>
                        </select>    
                ...
                <div class="ticket_option"><span class="semi-bold">Your Problem</span>
                  ...
                  <textarea name="catatan" required oninvalid="setCustomValidity('Catatan Pemohon Harus di Isi !')"
                    oninput="setCustomValidity('')" class="form_ticket_question" autofocus></textarea>
                  </div>
           ...
           <fieldset id="form_pengajuan">           
              <form id="myForm" >
                <h4><span class="semi-bold">PC/Laptop Submission</span></h4>
                <p>Make a PC or laptop application by filling in the application form which will be processed by the relevant department.</p>
                <div class="ticket_option">
                  <div class="form_ticket_subject"> <span class="semi-bold">Submission Type</span>
                    <div class="input-group ">
                        <select name="jenis_pengajuan" class="form-control" id="jenis_pengajuan">
                          <option value="" selected="selected">- Submission Type -</option>                 
                ...
                <div class="ticket_option">
                  <div class="form_ticket_subject"> <span class="semi-bold">Departement</span>
                    <div class="input-group ">
                  ...
                  <div class="form_ticket_subject"> <span class="semi-bold">Position</span>
                    <div class="input-group">
                        <input type="text" name="jabatan" id="jabatan" class="form-control" required oninvalid="setCustomValidity('Jabatan')" oninput="setCustomValidity('')" placeholder="Position" >    
                    </div>
                  </div> 
                </div>  
                <div class="ticket_option">
                  <div class="form_ticket_subject"> <span class="semi-bold">Name</span>
                    <div class="input-group ">
                    <input type="text" name="nama" id="nama" class="form-control" required oninvalid="setCustomValidity('Nama')" oninput="setCustomValidity('')" placeholder="User Name" >    
                    </div>
                  </div>   
                  <div class="form_ticket_subject"> <span class="semi-bold">Gender</span>
                    <div class="input-group">
                ...
                <div class="ticket_option">
                  <div class="form_ticket_subject"> <span class="semi-bold">Email Address</span>
                    <div class="input-group ">
                  ...
                  <div class="form_ticket_subject"> <span class="semi-bold">Office Location</span>
                    <div class="input-group">
                        <input type="text" name="lokasi" id="lokasi" class="form-control" required oninvalid="setCustomValidity('Lokasi')" oninput="setCustomValidity('')" placeholder="Office Location" >    
                    </div>
                  </div> 
                </div>  
                <div class="ticket_option">
                  <div class="form_ticket_subject"> <span class="semi-bold">Inventory Type</span>
                    <div class="input-group ">
                        <select name="jenis_inv" class="form-control" id="jenis_inv">
                          <option value="" selected="selected">- Inventory Type -</option>                 
                          <option value="Laptop">LAPTOP</option> 
                          <option value="Komputer">COMPUTER</option> 
                          <option value="Monitor">MONITOR</option> 
                          <option value="Printer">PRINTER</option> 
                  ...
                  <div class="form_ticket_subject"> <span class="semi-bold">Phone Number</span>
                    <div class="input-group">
          ...
          <div class="col-md-7">
            <fieldset id="list-ticketing">
                ...
                if ($ticket->num_rows()>0){
                  ...
                  echo'
                    <div class="alert alert-success alert-dismissable">                
                      <h4><i  class="icon fa fa-check"></i> Open Ticket Status Still Empty</h4>
              ...
              <div class="ticket_open">
                ...
                if ($ticketclose->num_rows()>0){
                  ...
                  echo'
                    <div class="alert alert-success alert-dismissable">                
                      <h4><i  class="icon fa fa-check"></i> Close Ticket Data Still Empty</h4>
            ...
            <fieldset id="list-pengajuan">
              <div class="ticket_open">
                  <div class="ticket_open_heading">
                    <h3 class="pull-left"><span class="semi-bold">PC/Laptop Submission</span></h3>                    
                  </div>
              </div>
              <div class="ticket_open">
