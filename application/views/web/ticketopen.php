          ...
          <?php
            ...
            ?>  
              ...
              if(!empty($detail)){
                foreach ($detail->result() as $r) {
                  echo '
                      ...
                      <div class="ticket_problem">'.$r->catatan.'</div>
              ...
              <div class="input-group">
               <textarea name="catatan" cols="" rows="" class="form_ticket_question2" required oninvalid="setCustomValidity('Not Empty Comment !')" oninput="setCustomValidity('')" placeholder="add comment"></textarea>
